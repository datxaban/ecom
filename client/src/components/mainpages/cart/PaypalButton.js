...
export default class PaypalButton extends React.Component {
    render() {
        ...
        const client = {
            sandbox: 'ATJ-vNqsJgqA5NO4Xxd4iWH9WbuRaVihUbI6j8ZtMFYoPsCyyaN2w0IENHHzz_hlEUsxIGB2Hv3B3ur5',
            production: 'YOUR-PRODUCTION-APP-ID',
        }
        // ATJ-vNqsJgqA5NO4Xxd4iWH9WbuRaVihUbI6j8ZtMFYoPsCyyaN2w0IENHHzz_hlEUsxIGB2Hv3B3ur5
